...
public class PreparedStatementWrapper implements PreparedStatement {
    ...
    private final PreparedStatement decorated;
    private final DecoratorFactory<ResultSet, PreparedStatementWrapper> resultSetFactory;

    public PreparedStatementWrapper(PreparedStatement decorated) {
        this(decorated, new NoOpDecoratorFactory<ResultSet, PreparedStatementWrapper>());
    }

    public PreparedStatementWrapper(PreparedStatement decorated, DecoratorFactory<ResultSet, PreparedStatementWrapper> resultSetFactory) {
        this.decorated = checkNotNull(decorated);
        this.resultSetFactory = checkNotNull(resultSetFactory);
    }

    @Override
    public ResultSet executeQuery() throws SQLException {
        return resultSetFactory.decorate(decorated.executeQuery(), this);
    }
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        return resultSetFactory.decorate(decorated.executeQuery(sql), this);
    }
    ...
    public ResultSet getResultSet() throws SQLException {
        return resultSetFactory.decorate(decorated.getResultSet(), this);
    }
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        return resultSetFactory.decorate(decorated.getGeneratedKeys(), this);
    }
